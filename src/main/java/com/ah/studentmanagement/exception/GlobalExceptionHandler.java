package com.ah.studentmanagement.exception;
...
public class GlobalExceptionHandler {
    ...
    public String csrfExceptionHandler(Exception ex, RedirectAttributes redirectAttributes){
    ...
    public String genericExceptionHandler(Exception ex){
        ...
        log.error("Global Exception Handler -2 ", ex.getMessage());
        return "500";
    }
}
